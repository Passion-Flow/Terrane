...
# the private images.
# 用法: bash generate-image-repo-secret.sh <username> <password> <namespace> <registry-url>
# 例:   bash generate-image-repo-secret.sh robot 'pass' terrane https://crpi-xxx.cr.aliyuncs.com
set -euo pipefail
